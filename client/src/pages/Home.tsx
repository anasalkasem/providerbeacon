...
export default function Home() {
  ...
  return (
    <PublicLayout>
      <div
        className={`beacon-landing${isOrbit ? " orbit-home" : isStudio ? " studio-home" : ""}`}
              ...
              <div className="landing-hero-copy">
                ...
                <form
                  ...
                  onSubmit={event => {
                    ...
                    navigate(
                      request
                        ? `/find?q=${encodeURIComponent(request)}`
                        : "/find"
                    );
                  }}
                >
                  ...
                  {isOrbit && (
                    <span className="orbit-search-label">{t.ask}</span>
                  )}
                  <Search
