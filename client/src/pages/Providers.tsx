...
export default function Providers() {
  ...
  const visible = useMemo(() => providers.filter(provider => `${provider.name} ${provider.location} ${provider.description} ${localizeData(locale, provider.location)} ${localizeData(locale, provider.description)}`.toLowerCase().includes(query.toLowerCase())), [locale, query]);
  return <PublicLayout>
