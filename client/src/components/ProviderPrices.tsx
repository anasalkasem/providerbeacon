...
const translations = {
  en: { title: "Published service prices", unavailable: "Prices temporarily unavailable", empty: "No published prices", unconfirmed: "Currency not confirmed", pending: "Services with an unconfirmed currency", note: "Ranges cover different services, not equivalent offers or a final quote.", all: "View all services and prices", more: "Additional pricing groups" },
  ar: { title: "أسعار الخدمات المنشورة", unavailable: "الأسعار غير متاحة مؤقتًا", empty: "لا توجد أسعار منشورة", unconfirmed: "العملة غير مؤكدة", pending: "خدمات لم تُؤكد عملتها", note: "النطاقات تشمل خدمات مختلفة، وليست مقارنة لعروض متكافئة أو عرض سعر نهائيًا.", all: "عرض جميع الخدمات والأسعار", more: "مجموعات أسعار إضافية" },
  es: { title: "Precios de servicios publicados", unavailable: "Precios temporalmente no disponibles", empty: "No hay precios publicados", unconfirmed: "Moneda sin confirmar", pending: "Servicios con moneda sin confirmar", note: "Los rangos abarcan servicios distintos; no son ofertas equivalentes ni una cotización final.", all: "Ver todos los servicios y precios", more: "Grupos de precios adicionales" },
  hi: { title: "प्रकाशित सेवाओं की कीमतें", unavailable: "कीमतें अस्थायी रूप से उपलब्ध नहीं हैं", empty: "कोई प्रकाशित कीमत नहीं", unconfirmed: "मुद्रा की पुष्टि नहीं हुई", pending: "अपुष्ट मुद्रा वाली सेवाएँ", note: "सीमाएँ अलग-अलग सेवाओं की हैं, समान ऑफ़र या अंतिम मूल्य नहीं।", all: "सभी सेवाएँ और कीमतें देखें", more: "अतिरिक्त मूल्य समूह" },
  zh: { title: "已发布服务价格", unavailable: "价格暂时不可用", empty: "暂无已发布价格", unconfirmed: "货币未确认", pending: "货币未确认的服务", note: "价格范围涵盖不同服务，并非同等报价比较或最终报价。", all: "查看所有服务和价格", more: "更多价格分组" },
};
