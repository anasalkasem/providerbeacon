...
const strings = {
  ...
  awaiting: [
    "Your offer starts when your provider plan is first activated.",
    "يبدأ عرضك عند أول تفعيل لباقة مزودك.",
    "Tu oferta comienza con la primera activación del plan del proveedor.",
    "प्रदाता प्लान के पहले सक्रियण पर आपका ऑफ़र शुरू होता है।",
    "供应商套餐首次开通时，优惠期开始。",
  ],
  manual: [
    "You approve each monthly payment. Automatic billing is not enabled.",
    "توافق على دفع كل شهر. الخصم التلقائي غير مفعّل.",
    "Autorizas cada pago mensual. El cobro automático no está habilitado.",
    "हर मासिक भुगतान आपकी मंज़ूरी से होता है। स्वचालित भुगतान चालू नहीं है।",
    "每次月费付款均需您确认，不会自动扣款。",
  ],
  customPeriod: [
